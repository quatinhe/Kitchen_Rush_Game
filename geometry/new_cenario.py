...
class CenarioGeometry(Geometry):
    def __init__(self):
        ...
        self.texture = Texture(file_name="images/cozinhaf.png")
        self.geometry_mesa = Model('blender/sala.obj')
        self.material = TextureMaterial(texture=self.texture)
        # self.material = PhongMaterial( texture=self.texture)
        self.mesh_cenario = Mesh(self.geometry_mesa, self.material)
        ###################################
        ...
        self.objeto.add(self.mesh_cenario)
