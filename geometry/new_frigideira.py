...
class FrigideiraGeometry(Geometry):
    def __init__(self):
        self.texture = Texture(file_name="textures/dark-metal.jpg")
        self.geometry_frigideira = Model('blender/frigideira.obj')
        # self.material = TextureMaterial(texture=self.texture)
        self.material = PhongMaterial(texture=self.texture)
       
        self.mesh_frigideira = Mesh(self.geometry_frigideira, self.material)
        ...
        self.objeto.add(self.mesh_frigideira)
